...
const useBlackTheme=()=>{const[blackTheme,setBlackTheme]=useState(()=>localStorage.getItem('workneo-theme')==='black');useEffect(()=>{document.body.classList.toggle('theme-black',blackTheme);localStorage.setItem('workneo-theme',blackTheme?'black':'light');return()=>document.body.classList.remove('theme-black')},[blackTheme]);return[blackTheme,()=>setBlackTheme(v=>!v)]};
