...
const useBlackTheme=()=>{const[blackTheme,setBlackTheme]=useState(()=>localStorage.getItem('workneo-theme-v2')!=='light');useEffect(()=>{document.body.classList.toggle('theme-black',blackTheme);document.documentElement.classList.toggle('theme-black',blackTheme);localStorage.setItem('workneo-theme-v2',blackTheme?'black':'light');return()=>{document.body.classList.remove('theme-black');document.documentElement.classList.remove('theme-black')}},[blackTheme]);return[blackTheme,()=>setBlackTheme(v=>!v)]};
