...
function App(){
const[blackTheme,toggleBlackTheme]=useBlackTheme();
const[tab,setTab]=useState('listas'),[lists,setLists]=useState(()=>read(LISTS_KEY)),[reports,setReports]=useState(()=>read(REPORTS_KEY)),[sendControlOpen,setSendControlOpen]=useState(false);
